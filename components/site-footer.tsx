...
export function SiteFooter({ locale = "canonical" }: { locale?: Locale }) {
  if (!isWillsleep) return null;

  return (
    <footer className="absolute inset-x-0 bottom-0 z-20 pb-8 text-center font-mono text-xs text-white/40">
